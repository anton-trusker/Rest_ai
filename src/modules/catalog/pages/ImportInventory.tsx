                ...
                {step === 0 && (
                    <div className="space-y-6">
                        ...
                        <div
                            ...
                            onDrop={handleDrop}
                            className={`border-2 border-dashed rounded-xl p-12 text-center transition-colors cursor-pointer ${dragOver ? 'border-primary bg-primary/5' : 'border-border hover:border-muted-foreground'
                                }`}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {mappings.map((m, i) => {
                                ...
                                return (
                                    <div key={i} className={`flex items-center gap-4 p-3 rounded-lg border transition-colors ${isMapped ? 'border-primary/20 bg-primary/5' : 'border-border'
                                        }`}>
