...
import { mockMovements } from '@/core/lib/mockData'; // Assuming movements are also in mockData now, based on previous `mockData.ts` check. Wait, I should verify if I moved movements.
// I viewed `mockData.ts` and it had `InventoryMovement`.
...
export default function Dashboard() {
    ...
    // Using mockMovements from where they are available.
    // In previous step I saw `mockData.ts` moved to `src/core/lib/mockData.ts`.
    // I need to ensure `mockMovements` is exported there.
    // Viewing `InventoryHistory` earlier, it imported `mockMovements` from `@/core/lib/mockData`.
